...
const MentorProfileCreation: React.FC<MentorProfileCreationProps> = ({
  ...
  console.log("MentorProfileCreation props:", { isEditMode, existingData });
  ...
  console.log("MentorProfileCreation formData initialized:", formData);
  console.log("MentorProfileCreation existingData received:", existingData);
  ...
  useEffect(() => {
    if (isEditMode && existingData) {
      console.log("Updating form data with existing data:", existingData);
      setFormData({
        firstName: existingData.firstName || "",
        lastName: existingData.lastName || "",
        title: existingData.title || "",
